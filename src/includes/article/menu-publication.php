        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li ><a href="/actualite"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span> Actualités</a></li>
                 <li><a href="/profil?id=<?php echo $_SESSION['id']?>"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Profil</a></li>

                <li class="active"><a href="/envoie-photo"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Publications</a></li>
