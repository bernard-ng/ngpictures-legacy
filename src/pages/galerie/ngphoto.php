        ...
        <div class="ng-article-img">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 col-md-8 col-lg-8">
                <div class="row">
                    ...
                    <center>
                    <img src="ngimages/640-640/<?php echo getBlogPicturesThumb($photoID)?>"/>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class=" ng-panel panel panel-primary ng-panel-active ">
                    ...
                    <li class="list-group-item  ">
                        <a class="btn btn-primary btn-xs ng-btn" href="../src/script/ngdownload.php?n=<?php echo getBlogPicturesThumb($photoID)?>" role="button"><span class="glyphicon glyphicon-save"></span></a> Télécharger

                    </li>
                    <li class="list-group-item  ">
                        <a class="btn btn-primary btn-xs ng-btn" href="../src/script/nglike_photo.php?t=1&id=<?php echo $getID ?>" role="button"><span class="glyphicon glyphicon-thumbs-up"></span></a> <?php echo check_nglikep_statut($photoID, $_SESSION['id']) ?>
                        <span class="ng-badge badge"><?php echo KMF(getBlogPicturesInfo($photoID, "like")) ?></span>
                    </li>
                    <li class="list-group-item ">
                        <a class="btn btn-primary btn-xs ng-btn" href="../src/script/nglike_photo.php?t=2&id=<?php echo $getID ?>" role="button"><span class="glyphicon glyphicon-thumbs-down"></span></a> <?php echo check_ngdislikep_statut($photoID, $_SESSION['id']) ?>
                        <span class="ng-badge badge"><?php echo KMF(getBlogPicturesInfo($photoID, "dislike")) ?></span>

                    </li>
                    <li class="list-group-item ">
                         <a class="btn btn-primary btn-xs ng-btn" href="../src/script/nglike_photo.php?t=3&id=<?php echo $getID ?>" role="button"><span class="glyphicon glyphicon-heart"></span></a> <?php echo check_nglovep_statut($photoID, $_SESSION['id']) ?> <span class="ng-badge badge"><?php echo KMF(getBlogPicturesInfo($photoID, "love")) ?></span>
    ...
    <div class="row">
        <div class="ng-panel panel panel-primary">
            <div class="ng-panel panel-heading ng-margin-default" role="tab" >
                    ...
                    <span class="ng-badge badge"><?php echo KMF(getBlogPicturesInfo($photoID, "commentaire"))?></span>
                </div>
    <?php
...
<?php if($Nc >= 1) {
    ...
    <?php if(getBlogPicturesInfo($photoID, "commentaire") > 3) {?>
            ...
            <a href="ngcomment.php?id=<?php echo $_GET['id']?>"><center>Voir plus</center></a>
            </li>
        </ul>
    <?php }
}
