...
if(isset($_SESSION['id']) and !empty($_SESSION['id'])) {
    if(isset($_GET['id']) and !empty($_GET['id'])) {
        ...
        if($news->rowcount() ==1) {
            ...
            $commentaire= $db->prepare("SELECT * from ngcommentaire where photoID=? order by date_pub desc ");
            $commentaire->execute(array($photoID));

            $comN = $db->prepare("SELECT * from ngcommentaire where photoID=? order by date_pub desc ");
...
<head>
    ...
    <title>COMMENTAIRES-<?php echo $titre ?></title>
...
<body>
<section class="ng-bloc-principal section">
...
<div class="col-xs-12 col-sm-8 col-md-8 col-lg=8" >
    ...
    <div class="ng-panel panel-heading ng-margin-default">COMMENTAIRE<?php echo $t = (getBlogPicturesInfo($photoID, "commentaire") > 1)? "S" : ""  ?> <span class="ng-badge badge"><?php echo $com ?></span></div>
