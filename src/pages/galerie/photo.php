...
if(isset($_SESSION['id']) and !empty($_SESSION['id'])) {
    ...
    if(isset($_GET['type'], $_GET['id']) and !empty($_GET['type']) and !empty($_GET['id'])) {
        ...
        if($news->rowcount() ==1) {
            ...
            $tags= $news['tags'];
            $photoID= $news['id'];
            $posterID = getPicturesInfo($photoID, "posterID");
            $date= $news['date_pub'];
    ...
    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
              <div class="media">
                    <div class="media-body">
                          <p class="text-left"><?php echo text($tags)?></p>
                    </div>
              </div>
        </div>
        <br>
        <div class="ng-article-img">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 col-md-8 col-lg-8">
                <div class="row">
                    ...
                    <center>
                        <img src="pages/galerie/images/640-640/<?php echo getPicturesThumb($photoID)?>"/>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class=" ng-panel panel panel-primary ng-panel-active ">
                    ...
                    <li class="list-group-item  ">
                        <a class="btn btn-primary btn-xs ng-btn" href="../src/script/download.php?n=<?php echo getPicturesThumb($photoID)?>" role="button"><span class="glyphicon glyphicon-save"></span></a> Télécharger

                    </li>
                    <li class="list-group-item  ">
                        <a class="btn btn-primary btn-xs ng-btn" href="../src/script/like_photo.php?t=1&id=<?php echo $getID ?>" role="button"><span class="glyphicon glyphicon-thumbs-up"></span></a> <?php echo check_likep_statut($photoID, $_SESSION['id']) ?>
                        <span class="ng-badge badge"><?php echo KMF(getPicturesInfo($photoID, "like")) ?></span>
                    </li>
                    <li class="list-group-item ">
                        <a class="btn btn-primary btn-xs ng-btn" href="../src/script/like_photo.php?t=2&id=<?php echo $getID ?>" role="button"><span class="glyphicon glyphicon-thumbs-down"></span></a> <?php echo check_dislikep_statut($photoID, $_SESSION['id']) ?>
                        <span class="ng-badge badge"><?php echo KMF(getPicturesInfo($photoID, "dislike")) ?></span>

                    </li>
                    <li class="list-group-item ">
                         <a class="btn btn-primary btn-xs ng-btn" href="../src/script/like_photo.php?t=3&id=<?php echo $getID ?>" role="button"><span class="glyphicon glyphicon-heart"></span></a> <?php echo check_lovep_statut($photoID, $_SESSION['id']) ?> <span class="ng-badge badge"><?php echo KMF(getPicturesInfo($photoID, "love")) ?></span>
...
<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
    <div class="row">
        <div class="ng-panel panel panel-primary">
            <div class="ng-panel panel-heading ng-margin-default" role="tab" >
                    <span class="glyphicon glyphicon-chevron-right"></span>  COMMENTAIRE<?php echo $t = (getPicturesInfo($photoID, "commentaire") > 1)? "S" : "" ?>
                    <span class="ng-badge badge"><?php echo KMF(getPicturesInfo($photoID, "commentaire"))?></span>
                </div>
    <?php

    $commentaire= $db->prepare("SELECT * from commentaire where photoID=? order by date_pub desc limit 0,3");
       ...
       <div class="media">
         <div class="media-left media-top">
          ...
          <div class="media-body">
            ...
            <span class="pull-right">
            <time>
             <span class="glyphicon glyphicon-time"></span> <?php echo getRelativeTime($c['date_pub'])?></time></span>
          </div>
       </div>
      </li>
    <?php }?>

    <?php if(getPicturesInfo($photoID, "commentaire") > 3) {?>

            <li class="list-group-item ng-margin-default">
                <a href="comment.php?id=<?php echo $_GET['id']?>"><center>Voir plus</center></a>
            </li>
        </ul>
