		...
		<div class="ng-article-img">
			<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 col-md-8 col-lg-8">
				<div class="row">
					...
					<center>
						<img src="pages/galerie/images/640-640/<?= getPicturesThumb($photoID)?>"/>
					</center>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class=" ng-panel panel panel-primary ng-panel-active ">
		            ...
		            <li class="list-group-item  ">
						<a class="btn btn-primary btn-xs ng-btn" href="../src/script/download.php?n=<?= getPicturesThumb($photoID)?>" role="button"><span class="glyphicon glyphicon-save"></span></a> Télécharger

					</li>
		            <li class="list-group-item  ">
						<a class="btn btn-primary btn-xs ng-btn" href="../src/script/like_photo.php?t=1&id=<?= $getID ?>" role="button"><span class="glyphicon glyphicon-thumbs-up"></span></a> <?= check_likep_statut($photoID,$_SESSION['id']) ?>
						<span class="ng-badge badge"><?= KMF(getPicturesInfo($photoID,"like")) ?></span>
					</li>
					<li class="list-group-item ">
						<a class="btn btn-primary btn-xs ng-btn" href="../src/script/like_photo.php?t=2&id=<?= $getID ?>" role="button"><span class="glyphicon glyphicon-thumbs-down"></span></a> <?= check_dislikep_statut($photoID,$_SESSION['id']) ?>
						<span class="ng-badge badge"><?= KMF(getPicturesInfo($photoID,"dislike")) ?></span>

					</li>
					<li class="list-group-item ">
						 <a class="btn btn-primary btn-xs ng-btn" href="../src/script/like_photo.php?t=3&id=<?= $getID ?>" role="button"><span class="glyphicon glyphicon-heart"></span></a> <?= check_lovep_statut($photoID,$_SESSION['id']) ?> <span class="ng-badge badge"><?= KMF(getPicturesInfo($photoID,"love")) ?></span>
	...
	<div class="row">
		<div class="ng-panel panel panel-primary">
			<div class="ng-panel panel-heading ng-margin-default" role="tab" >
		            ...
		            <span class="ng-badge badge"><?= KMF(getPicturesInfo($photoID,"commentaire"))?></span>
		    	</div>
		<?php
	...
	while($c = $commentaire->fetch()){ ?>
				...
				<div class="media">
				 	<div class="media-left media-top">
				  	...
				  	<div class="media-body">
					    ...
					    <span class="pull-right">
					    <time>
					    	<span class="glyphicon glyphicon-time"></span> <?= getRelativeTime($c['date_pub'])?></time></span>
				  	</div>
				</div>
			</li>
		<?php }?>
		...
		<?php if(getPicturesInfo($photoID,"commentaire") > 3){?>
			...
			<li class="list-group-item ng-margin-default">
				<a href="comment.php?id=<?= $_GET['id']?>"><center>Voir plus</center></a>
			</li>
		</ul>
