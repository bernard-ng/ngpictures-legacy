...
<div class="col-xs-12 col-sm-8 col-md-8 col-lg=8" >
    ...
    <div class="ng-panel panel-heading ng-margin-default">COMMENTAIRE<?php echo $t = (getPicturesInfo($photoID, "commentaire") > 1)? "S" : ""  ?> <span class="ng-badge badge"><?php echo $com ?></span></div>
