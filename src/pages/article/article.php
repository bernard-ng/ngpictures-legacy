    ...
    <div class="row" >
        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
            <div class="media">
                ...
                <legend><small><a href="pages/membres/profil.php?id=<?php echo $posterID ?>">Par <?php echo getUserPseudo($posterID) ?></a></small></legend>
        ...
        <div class="ng-article-img">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="row">
                    ...
                    <img src="pages/article/miniature/640-640/<?php echo getPostThumb($articleID)?>" />
            ...
            <div class=" ng-panel panel panel-primary ng-panel-active ">
                ...
                <ul class="list-group ng-margin-default">
                    <li class="list-group-item  ">
                        <a class="btn btn-primary btn-xs ng-btn" href="/src/script/like.php?t=1&id=<?php echo $getID ?>" role="button"><span class="glyphicon glyphicon-thumbs-up"></span></a> <?php echo check_like_statut($articleID, $_SESSION['id']) ?>
                        <span class="ng-badge badge"><?php echo KMF(getArticleInfo($articleID, "like")) ?></span>
                    </li>
                    <li class="list-group-item ">
                        <a class="btn btn-primary btn-xs ng-btn" href="/src/script/like.php?t=2&id=<?php echo $getID ?>" role="button"><span class="glyphicon glyphicon-thumbs-down"></span></a> <?php echo check_dislike_statut($articleID, $_SESSION['id']) ?>
                        <span class="ng-badge badge"><?php echo KMF(getArticleInfo($articleID, "dislike")) ?></span>
                    </li>
                    <li class="list-group-item ">
                         <a class="btn btn-primary btn-xs ng-btn" href="/src/script/like.php?t=3&id=<?php echo $getID ?>" role="button"><span class="glyphicon glyphicon-heart"></span></a> <?php echo check_love_statut($articleID, $_SESSION['id']) ?> <span class="ng-badge badge"><?php echo KMF(getArticleInfo($articleID, "love")) ?></span>
                    </li>
                </ul>
...
<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
    <div class="row">
        <div class="ng-panel panel panel-primary">
            <div class="ng-panel panel-heading ng-margin-default" role="tab" >
                    <span class="glyphicon glyphicon-chevron-right"></span>  COMMENTAIRE<?php echo $t = (getArticleInfo($articleID, "commentaire") > 1)? "S" : "" ?>
                    <span class="ng-badge badge"><?php echo KMF(getArticleInfo($articleID, "commentaire"))?></span>
                </div>
    <?php
...
<?php if($Nc >= 1) {
    ...
    <?php if(getArticleInfo($articleID, "commentaire") > 4) {?>
            ...
            <a href="pages/article/comment.php?id=<?php echo $_GET['id']?>"><center>Voir plus</center></a>
            </li>
        </ul>
    <?php }
}
