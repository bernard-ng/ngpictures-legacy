...
<head>
	...
	<title><?= "Edition profil | ".getUserPseudo($_SESSION['id']) ?></title>
	...
	<div class="hidden-xs col-lg-3 col-sm-3 col-md-3">
		<div class="row">
			<div class="ng-panel panel panel-primary">
				...
				<div class="ng-article-img">
					<div class="card--date">
						<div class="card--date--day"><?= getDay(getTodayDate())?></div>
						<div class="card--date--month"><?= getMonth(getTodayDate());?></div>
					</div>

					<img class="img-circle" src="pages/membres/Avatar/640-640/<?= getUserProfil($_SESSION['id']) ?>" width="200" />
