...
<div class="col-xs-12 col-sm-8 col-md-8 col-lg=8" >
	<div class="row">
		...
		<div class="ng-panel panel-heading ng-margin-default">COMMENTAIRE<?= $t = (getBlogInfo($articleID,"commentaire") > 1)? "S" : ""  ?> <span class="ng-badge badge"><?= $com ?></span></div>
