    ...
    <div class="media">
        <div class="container">
            <div class="media-body" >
                ...
                Salut <b><?= getUserPseudo($_SESSION['id']) ?></b>, Nous avons besoin de tes idées pour améliorer notre site, pour faire des mis à jour...
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    <form action="#" method="POST">
        <div class="form-group">
            <textarea type="text" class="textarea-default" id="idee" name="idee" placeholder="Merci pour votre idée..."><?php if(isset($_POST['id'])){ echo $_POST['id']; }?></textarea>
        </div>
        <div class="row">
            <div class="col-xs-12">
